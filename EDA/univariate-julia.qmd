...
: Various indexing patterns.  {#tbl-indexing-patterns tbl-colwidths="[30,70]"}
...
: Various convenient iterators in `Julia` {#tbl-iterators tbl-colwidths="[25,75]"}
...
: Various measures of center, spread, and position in a univariate data set.  {#tbl-measures-center-spread-position tbl-colwidths="[25,25,50]"}
